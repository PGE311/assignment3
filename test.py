...
class TestSolution(unittest.TestCase):
    ...
    def test_is_evenly_divisible_private_1(self):
        
        ans = is_evenly_divisible(9, 3)

        self.assertEqual(ans, "9 is evenly divisible by 3!")
        
    def test_is_evenly_divisible_private_2(self):
        
        ans = is_evenly_divisible(15, 4)

        self.assertEqual(ans, "15 is not evenly divisible by 4. The remainder is 3.")
    ...
    def test_math_operation_private_1(self):
        
        ans = math_operation(5, 5, 'add')
        
        self.assertAlmostEqual(ans, 10, places=6)
        
    def test_math_operation_private_2(self):
        
        ans = math_operation(4, 4, 'subtract')
        
        self.assertAlmostEqual(ans, 0, places=6)
        
    def test_math_operation_private_3(self):
        
        ans = math_operation(5, 5, 'multiply')
        
        self.assertAlmostEqual(ans, 25, places=6)
        
    def test_math_operation_private_4(self):
        
        ans = math_operation(20, 5, 'divide')
        
        self.assertAlmostEqual(ans, 4, places=6)
